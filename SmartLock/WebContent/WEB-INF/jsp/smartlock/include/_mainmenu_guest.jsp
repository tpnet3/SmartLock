    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                -->
                <li <%= (_nav != null && _nav.equals("about_us")) ? "class=\"active\"" : "" %> data-toggle="tooltip" data-placement="bottom" title="서비스 소개">
                    <a href="/about_us">서비스 소개</a>
                </li>
                <li <%= (_nav != null && _nav.equals("software")) ? "class=\"active\"" : "" %> data-toggle="tooltip" data-placement="bottom" title="소프트웨어 목록">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/login" data-toggle="tooltip" data-placement="bottom" title="로그인">로그인</a></li>
                <li><a href="/signup" data-toggle="tooltip" data-placement="bottom" title="회원가입">회원가입</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
