						...
						<div class="form-group">
							...
							<div class="col-md-3">
								...
								<select id="corp-phone-1"
									...
									<option>018</option>
									<option>019</option>
								</select> <b style="width: 5%">-</b> <input id="corp-phone-2"
									type="number"
									style="width: 28%; display: inline; text-align: center"
									class="form-control input-md" max="9999" maxlength="4"
									oninput="maxLengthCheck(this)"> <b style="width: 5%">-</b>
								<input id="corp-phone-3" type="number"
									style="width: 28%; display: inline; text-align: center"
									class="form-control input-md" max="9999" maxlength="4"
